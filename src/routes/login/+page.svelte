...
<svelte:head>
	<title>Login - PBB Admin Panel</title>
</svelte:head>
	...
	<div class="w-full max-w-md space-y-4">
		<div class="text-center">
			<div class="mb-2 flex justify-center">
				<img src={pbbLogo} alt="PBB Logo" class="h-48 w-48" />
			</div>
			<h2 class="mb-1 text-2xl font-bold" style="color: var(--text-primary);">
				{$translationStore.translations?.common.adminPanel || 'Admin Panel'}
			</h2>
			<p class="text-sm" style="color: var(--text-secondary);">
				{$translationStore.translations?.login.signInToAccount || 'Sign in to your account'}
			</p>
		</div>
			...
			<div class="-space-y-px rounded-md shadow-sm">
				<div>
					...
					<input
						...
						type="text"
						required
						class="relative block w-full appearance-none rounded-none rounded-t-md border px-3 py-2 focus:z-10 focus:outline-none sm:text-sm"
				...
				<div>
					...
					<input
						...
						type="password"
						required
						class="relative block w-full appearance-none rounded-none rounded-b-md border px-3 py-2 focus:z-10 focus:outline-none sm:text-sm"
						style="border-color: var(--border-primary); background-color: var(--bg-secondary); color: var(--text-primary); --tw-placeholder-color: var(--text-tertiary);"
